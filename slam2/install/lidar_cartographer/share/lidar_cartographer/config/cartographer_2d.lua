...
TRAJECTORY_BUILDER_2D.motion_filter.max_angle_radians = math.rad(0.7)  -- Modify 1.0 to 0.1, increased sensitivity to movement
-- TRAJECTORY_BUILDER_2D.motion_filter.max_distance_meters = 0.05  -- Set the threshold to 0.05 meter
